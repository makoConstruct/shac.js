...
(function() {
  ...
  matching = function(candidate, term, hitTag) {
    var ai, cacy, cap, char, cumulation, endTag, hit, hits, i, ie, lastSplit, originalChar, outp, score, splittedText, startTag, tagend, tagstart, termi, text, texti, ucterm, uctext, _i, _len;
    text = candidate.text;
